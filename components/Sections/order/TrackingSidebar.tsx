...
export default function TrackingSidebar({
  ...
  return (
    <>
      ...
      {/* Sidebar Panel */}
      <div
        className={`fixed top-0 right-0 w-4/5 md:w-[420px] h-screen bg-white z-[201] overflow-y-auto px-7 py-7 shadow-[-4px_0_20px_rgba(0,0,0,0.08)] transition-transform duration-300 ${
          ...
          <div className="relative pl-7">
            ...
            {stages.map((stage, idx) => (
              <div key={idx} className="relative mb-7">
                {/* Green dot */}
                <div className="absolute -left-4 top-0 w-6 h-6 rounded-full bg-[#22C55E] flex items-center justify-center z-10">
