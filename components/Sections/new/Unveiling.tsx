...
export default function OopsPage2({
  code,
  title,
  description,
}: OopsPageProps) {
  return (
    ...
    >
      ...
      <div className="absolute top-[-120] inset-0 flex justify-center pt-8 pointer-events-none">
      ...
      <div className="relative top-20 z-10 flex min-h-screen items-center justify-center px-6">
        <div className="w-full max-w-4xl">
          <div className="flex gap-30">
            {/* Left */}
            <div className="pt-2">
              <h2 className="text-10xl font-light text-neutral-7">
                {code}
              </h2>

              <p className="text-2xl top-[-20] relative left-2 text-neutral-7">
                {title}
              </p>
            </div>
            ...
            <div className="flex flex-col pt-8">
              <p className="text-neutral-12 text-2xl">
                {description}
              </p>
